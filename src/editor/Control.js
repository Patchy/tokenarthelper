...
export default class Control {
  ...
  toggleVisibleDiv(button, element) {
    ...
    this.editor.lastControlButtonClicked = button;
    this.editor.activeLayerSelectorElement = element.classList.contains("show") ? element : null;
  }
  ...
  constructor(editor, layer) {
    ...
    idSection.title = game.i18n.localize("tokenarthelper.label.LayerNumber");
  ...
  #configureMaskManagementSection() {
    ...
    this.maskControl.title = game.i18n.localize("tokenarthelper.label.ToggleBasicMask");
    ...
    maskEditControl.title = game.i18n.localize("tokenarthelper.label.EditMask");
    ...
    maskResetControl.title = game.i18n.localize("tokenarthelper.label.ResetMasks");
    ...
    masksControl.title = game.i18n.localize("tokenarthelper.label.AdvancedMaskApplication");
    ...
    blendImageText.title = game.i18n.localize("tokenarthelper.label.ImageBlendMode");
    ...
    blendMaskText.title = game.i18n.localize("tokenarthelper.label.MaskBlendMode");
  ...
  #configureTranslationControls() {
    ...
    positionManagementTitle.innerHTML = game.i18n.localize("tokenarthelper.label.Transform");
    this.positionManagementSection.appendChild(positionManagementTitle);

    this.visibleControl.classList.add("visible-layer");
    this.visibleControl.title = game.i18n.localize("tokenarthelper.label.VisibleLayer");
    ...
    this.activeControl.title = game.i18n.localize("tokenarthelper.label.EnableDisableTransformation");
    ...
    flipControl.title = game.i18n.localize("tokenarthelper.label.FlipLayer");
    ...
    resetControl.title = game.i18n.localize("tokenarthelper.label.ResetLayer");
    ...
    centreLayerControl.title = game.i18n.localize("tokenarthelper.label.CentreLayer");
    ...
    layerMovementControl.title = game.i18n.localize("tokenarthelper.label.LayerMovementControls");
    ...
    scaleControl.title = game.i18n.localize("tokenarthelper.label.ScaleButton");
  ...
  #configureDeletionSection() {
    ...
    duplicateControl.title = game.i18n.localize("tokenarthelper.label.CloneLayer");
    ...
    duplicateControl.addEventListener("click", (event) => {
      event.preventDefault();
      this.view.dispatchEvent(new CustomEvent("duplicate", { detail: { layerId: this.layer.id } }));
    });

    this.deleteControl.classList.add("delete-control");
    this.deleteControl.title = game.i18n.localize("tokenarthelper.label.DeleteLayer");
    ...
    this.deleteControl.addEventListener("click", (event) => {
      event.preventDefault();
      this.view.dispatchEvent(new CustomEvent("delete", { detail: { layerId: this.layer.id } }));
    });
  ...
  #configureColorManagement() {
    ...
    colorManagementTitle.innerHTML = game.i18n.localize("tokenarthelper.label.Color");
    this.colorManagementSection.appendChild(colorManagementTitle);

    this.colorSelector.type = "color";
    this.colorSelector.value = "#000000";

    this.colorSelectorProxy.title = game.i18n.localize("tokenarthelper.label.EditTint");
    this.colorSelectorProxy.classList.add("color-picker", "transparent");
    this.colorSelectorProxy.addEventListener("click", () => { this.colorSelector.click(); });
    this.colorSelector.addEventListener("change", (event) => {
      ...
      this.view.dispatchEvent(new CustomEvent("color", { detail: { layerId: this.layer.id, color: event.target.value } }));
    });

    this.clearColor.disabled = true;
    this.clearColor.classList.add("danger");
    this.clearColor.title = game.i18n.localize("tokenarthelper.label.ClearTint");
    ...
    this.clearColor.addEventListener("click", (event) => {
      event.preventDefault();
      this.view.dispatchEvent(new CustomEvent("color", { detail: { layerId: this.layer.id, color: null } }));
    });

    this.getColor.title = game.i18n.localize("tokenarthelper.label.PickTint");
    ...
    this.getColor.addEventListener("click", (event) => {
      ...
      if (this.getColor.classList.contains("active")) {
        ...
        this.view.dispatchEvent(new CustomEvent("pick-color-end", { detail: { layerId: this.layer.id } }));
      } else {
        this.getColor.classList.add("active");
        this.view.dispatchEvent(new CustomEvent("pick-color-start", { detail: { layerId: this.layer.id } }));
      }
    });
  }
  ...
  #configureMovementSection() {
    ...
    this.moveUpControl.title = game.i18n.localize("tokenarthelper.label.MoveLayerUp");
    ...
    this.moveUpControl.addEventListener("click", (event) => {
      event.preventDefault();
      this.view.dispatchEvent(new CustomEvent("move", { detail: { layerId: this.layer.id, direction: "up" } }));
    });

    this.moveDownControl.classList.add("move-control", "move-down");
    this.moveDownControl.title = game.i18n.localize("tokenarthelper.label.MoveLayerDown");
    ...
    this.moveDownControl.addEventListener("click", (event) => {
      event.preventDefault();
      this.view.dispatchEvent(new CustomEvent("move", { detail: { layerId: this.layer.id, direction: "down" } }));
    });
  ...
  #configureAdjustmentSection() {
    ...
    adjustmentSelectionControl.title = game.i18n.localize("tokenarthelper.label.Adjustments");
    ...
    opacityIcon.title = game.i18n.localize("tokenarthelper.label.Opacity");
    ...
    this.opacitySliderControl.title = game.i18n.localize("tokenarthelper.label.Opacity");
    ...
    this.opacitySliderControl.addEventListener("input", (event) => {
      event.preventDefault();
      this.view.dispatchEvent(new CustomEvent("opacity", { detail: { layerId: this.layer.id, opacity: event.target.value } }));
    ...
    brightnessIcon.title = game.i18n.localize("tokenarthelper.label.Brightness");
    ...
    this.brightnessSliderControl.title = game.i18n.localize("tokenarthelper.label.Brightness");
    ...
    this.brightnessSliderControl.addEventListener("input", (event) => {
      event.preventDefault();
      this.view.dispatchEvent(new CustomEvent("brightness", { detail: { layerId: this.layer.id, brightness: event.target.value } }));
    ...
    contrastIcon.title = game.i18n.localize("tokenarthelper.label.Contrast");
    ...
    this.contrastSliderControl.title = game.i18n.localize("tokenarthelper.label.Contrast");
    ...
    this.contrastSliderControl.addEventListener("input", (event) => {
      event.preventDefault();
      this.view.dispatchEvent(new CustomEvent("contrast", { detail: { layerId: this.layer.id, contrast: event.target.value } }));
    ...
    lineArtBlurSizeIcon.title = game.i18n.localize("tokenarthelper.label.LineArtBlurSize");
    ...
    this.lineArtBlurSizeControl.title = game.i18n.localize("tokenarthelper.label.LineArtBlurSize");
    ...
    this.lineArtEnableButton.title = game.i18n.localize("tokenarthelper.label.EnableLineArt");
    this.lineArtEnableButton.addEventListener("input", (event) => {
      event.preventDefault();
      this.lineArtBlurSizeControl.disabled = !event.target.checked;
      this.view.dispatchEvent(new CustomEvent("line-art-toggle", { detail: { layerId: this.layer.id, enabled: event.target.checked } }));
    });
    this.lineArtBlurSizeControl.addEventListener("input", (event) => {
      event.preventDefault();
      this.view.dispatchEvent(new CustomEvent("line-art-blur-size", { detail: { layerId: this.layer.id, size: event.target.value } }));
  ...
  #configureMagicLassoSection() {
    ...
    colorSelectionControl.title = game.i18n.localize("tokenarthelper.label.ColorChangeControl");
    ...
    colorThresholdSliderControl.title = game.i18n.localize("tokenarthelper.label.ColorThreshold");
    colorThresholdSliderControl.name = "color-threshold";
    colorThresholdSliderControl.addEventListener("input", (event) => {
      event.preventDefault();
      this.view.dispatchEvent(new CustomEvent("transparency-level", { detail: { layerId: this.layer.id, tolerance: event.target.value } }));
    });

    this.getAlpha.classList.add("popup-button");
    this.getAlpha.title = game.i18n.localize("tokenarthelper.label.PickAlpha");
    ...
    this.getAlpha.addEventListener("click", (event) => {
      ...
      if (this.getAlpha.classList.contains("active")) {
        ...
        this.view.dispatchEvent(new CustomEvent("pick-alpha-end", { detail: { layerId: this.layer.id } }));
      } else {
        this.getAlpha.classList.add("active");
        this.view.dispatchEvent(new CustomEvent("pick-alpha-start", { detail: { layerId: this.layer.id } }));
      }
    });
    ...
    transparencyResetControl.title = game.i18n.localize("tokenarthelper.label.ResetColorTransparency");
    let resetButtonText = document.createElement("i");
    resetButtonText.classList.add("fas", "fa-compress-arrows-alt");
    ...
    magicLassoControl.title = game.i18n.localize("tokenarthelper.label.MagicLasso");
  ...
  #tintControls() {
    ...
    colorTintSelector.value = "#000000";

    this.colorTintSelectorProxy.title = game.i18n.localize("tokenarthelper.label.EditLayerTint");
    this.colorTintSelectorProxy.classList.add("color-picker", "transparent");
    this.colorTintSelectorProxy.addEventListener("click", () => { colorTintSelector.click(); });
    colorTintSelector.addEventListener("change", (event) => {
      ...
      this.view.dispatchEvent(new CustomEvent("color-tint", { detail: { layerId: this.layer.id, color: event.target.value } }));
    });

    this.clearColorTint.disabled = true;
    this.clearColorTint.classList.add("danger", "popup-button");
    this.clearColorTint.title = game.i18n.localize("tokenarthelper.label.ClearTint");
    let clearButtonText = document.createElement("i");
    clearButtonText.classList.add("fas", "fa-minus-circle");
    this.clearColorTint.appendChild(clearButtonText);
    this.clearColorTint.addEventListener("click", (event) => {
      event.preventDefault();
      this.view.dispatchEvent(new CustomEvent("color-tint", { detail: { layerId: this.layer.id, color: null } }));
    });
  ...
  #addSelectLayerMasks() {
    ...
    this.layer.view.layers.forEach((layer) => {
      ...
      button.title = game.i18n.format("tokenarthelper.label.ToggleLayer", { layerNum });
      button.innerHTML = layer.getLayerLabel(active);
      button.addEventListener("click", (event) => {
        event.preventDefault();
        this.view.dispatchEvent(new CustomEvent("mask-layer", { detail: { layerId: this.layer.id, maskLayerId: layer.id } }));
      });
  ...
  refresh() {
    ...
    this.enableMoveUp();
    this.enableMoveDown();
    if (this.view.parentElement?.firstChild?.getAttribute("data-layer") === this.layer.id) this.disableMoveUp();
    if (this.view.parentElement?.lastChild?.getAttribute("data-layer") === this.layer.id) this.disableMoveDown();
  ...
  startColorPicking() { this.getColor.classList.add("active"); }
  endColorPicking() { this.getColor.classList.remove("active"); }
  startAlphaPicking() { this.getAlpha.classList.add("active"); }
  endAlphaPicking() { this.getAlpha.classList.remove("active"); this.colorBoxSpan.classList.toggle("show"); }
  enableMoveUp() { this.moveUpControl.disabled = false; }
  disableMoveUp() { this.moveUpControl.disabled = true; }
  enableMoveDown() { this.moveDownControl.disabled = false; }
  disableMoveDown() { this.moveDownControl.disabled = true; }
}
